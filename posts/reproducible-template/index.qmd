...
If you want to know the basics of `Docker`, check out [this](https://raw.githack.com/uo-ec607/lectures/master/13-docker/13-docker.html#1).
...
There are many build automations tools out there. One of the popular one is [GNU Make](https://www.gnu.org/software/make/).
