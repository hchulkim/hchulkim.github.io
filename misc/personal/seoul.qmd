...
- If you like theme parks, **[Lotte World Adventure](https://adventure.lotteworld.com/eng/main/index.do)**. It used to be the biggest **In-door Theme park** until 2010. It is also known for having many *[dark rides](https://en.wikipedia.org/wiki/Dark_ride)*. It also close to shopping mall (Lotte mall is right next to it) and **Lotte World Tower** which is currenlty the tallest building in Korea.[^1]
